  ...
  Widget _buildOldPendingView() {
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          const SizedBox(height: 30),
          _buildActionButton('Adjuntar Archivo (Simulado)', Icons.attach_file, Colors.lightGreen, Colors.white, onPressed: (){
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Simulando selección de archivo...')));
          }),
  ...
  Widget _buildActionButtonsSheet() {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        _buildActionButton('Adjuntar Archivo (Simulado)', Icons.attach_file, Colors.lightGreen, Colors.white, onPressed: _isLoading ? null : () {
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Simulando selección de archivo...')));
        }),
        const SizedBox(height: 12),
        _buildActionButton('Entregar Deber', Icons.check_box_outlined, Colors.pink, Colors.white, onPressed: _isLoading ? null : _submitHomework),
