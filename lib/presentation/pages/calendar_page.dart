    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: const [
            SizedBox(height: 6),
            Row(children: [Icon(Icons.circle, color: Colors.purple, size: 12), SizedBox(width: 6), Text("Fecha de Entrega", style: TextStyle(color: Colors.white))]),
            SizedBox(height: 4),
            Row(children: [Icon(Icons.circle, color: Colors.redAccent, size: 12), SizedBox(width: 6), Text("Faltas no Justificadas", style: TextStyle(color: Colors.white))]),
            SizedBox(height: 4),
            Row(children: [Icon(Icons.circle, color: Colors.indigo, size: 12), SizedBox(width: 6), Text("Asistencia", style: TextStyle(color: Colors.white))]),
            SizedBox(height: 4),
            Row(children: [Icon(Icons.circle, color: Colors.green, size: 12), SizedBox(width: 6), Text("Recordatorio", style: TextStyle(color: Colors.white))]),
          ],
        ),
      ),
    );
