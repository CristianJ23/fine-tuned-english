        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  const Text("Datos Personales", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF213354))),
                  const SizedBox(height: 16),
                  const CircleAvatar(radius: 60, backgroundImage: AssetImage('assets/perfil.jpg')),
                  const SizedBox(height: 24),
                  _buildInfoRow(Icons.person, "Alejandro XXXXXX"),
                  const SizedBox(height: 12),
                  _buildInfoRow(Icons.email, "xxxxxx@xxxx.com"),
